layui.define(['jquery', 'element'], function (exports) {
	...
	function createTab(option){
	    ...
	    var control = '<div class="layui-tab-control"><li class="layui-tab-prev layui-icon layui-icon-left" style="cursor: pointer;"></li><li class="layui-tab-next layui-icon layui-icon-right" style="cursor: pointer;"></li><li class="layui-tab-tool layui-icon layui-icon-down" style="cursor: pointer;"><ul class="layui-nav" lay-filter=""><li class="layui-nav-item"><a href="javascript:;"></a><dl class="layui-nav-child">';

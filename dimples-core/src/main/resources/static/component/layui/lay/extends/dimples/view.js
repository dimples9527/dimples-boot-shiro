...
layui
    .extend({
        // TODO 路径加载
        loadBar: '/dimples-shiro-web/static/component/layui/lay/extends/loadBar',
        dropdown: '/dimples-shiro-web/static/component/layui/lay/extends/dropdown'
    })
    .define(
        ...
        function (exports) {
            ...
            self.tab = {
                ...
                delAll: function (type) {
                    var tab = this;
                    var menuBtnClas = tab.menu + ' .dimples-tabs-btn';
                ...
                del: function (url, backgroundDel) {
                    ...
                    var lay = '[lay-url="' + url + '"]';
                    var thisBody = $(
                        '#dimples-body' + ' > .dimples-tabs-item' + lay
                    );
                ...
                change: function (route, callback) {
                    ...
                    var activeCls = 'dimples-tabs-active';
            ...
            self.createRequestParams = function (params) {
                ...
                if (params.api) {
                    ...
                    params.url = layui.api[params.api]
                }

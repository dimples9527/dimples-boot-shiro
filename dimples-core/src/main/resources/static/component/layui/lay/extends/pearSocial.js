				...
				'<div class="pear-social-list-body">'+
					'<div class="layui-side-scroll" style="width: 100%;">'+
						'<div pear-id="1" class="body layui-side-scroll session">'+
							...
							'<div class="body-item">'+
								'<img class="body-item-avatar" src="../../../../dimples/images/avatar/default.jpg"><span class="body-item-name">老大</span><span class="dot online"></span>'+
							'</div>'+
							'<div class="body-item">'+
								'<img class="body-item-avatar" src="../../../../dimples/images/avatar/default.jpg"><span class="body-item-name">老二</span><span class="dot"></span>'+
							'</div>'+
						...
						'<div pear-id="2" class="body layui-side-scroll list" style="display: none;">'+
						   ' <div class="body-item">'+
						    	'<img class="body-item-avatar" src="../../../../dimples/images/avatar/default.jpg"><span class="body-item-name">新的朋友</span>'+
						    '</div>'+
						...
						'<div pear-id="4" class="body layui-side-scroll" style="display: none;">'+
						   ' <div class="body-item">'+
								'<img class="body-item-avatar" src="../../../../dimples/images/avatar/default.jpg"><span class="body-item-name">老大</span>'+
							'</div>'+
						'</div>'+
					'</div>'+
			...
			'<div class="pear-social-body">'+
				...
				'<div class="pear-social-body-content">'+
					...
					'<div class="pear-social-body-content-chat">'+
						...
						'<ul class="content">'+
							'<li class="me"><img src="../../../../dimples/images/avatar/default.jpg" title="彩色系"><span>疾风知劲草，板荡识诚臣</span></li>'+
							'<li class="other"><img src="../../../../dimples/images/avatar/default.jpg" title="就眠仪式"><span>勇夫安知义，智者必怀仁</span></li>'+
						'</ul>'+
					'</div>'+

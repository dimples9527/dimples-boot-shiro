...
public class LoginLog implements Serializable {
    ...
    @ApiModelProperty(value = "loginLogId", hidden = true)
    ...
    public void setSystemBrowserInfo() {
        try {
            ...
            String browser = "";
            browser = buildBrowser(userAgent, indexOfIe, indexOfIe11, indexOfFirefox, indexOfChrome, containIe, containFirefox, containSoGou, containChrome, containSafari, browser);
            String os = "";
            os = buildOs(userAgent, indexOfMac, indexOfWindows, isMac, isWindows, isLinux, os);
            this.loginSystem = os;
    ...
    private String buildOs(StringBuilder userAgent, int indexOfMac, int indexOfWindows, boolean isMac, boolean isWindows, boolean isLinux, String os) {
        if (isMac) {
    ...
    private String buildBrowser(StringBuilder userAgent, int indexOfIe, int indexOfIe11, int indexOfFirefox, int indexOfChrome, boolean containIe, boolean containFirefox, boolean containSoGou, boolean containChrome, boolean containSafari, String browser) {
        if (containSoGou) {
            if (containIe) {
